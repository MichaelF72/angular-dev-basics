...
import { Post } from '../kapitel-06-http/kapitel-06-http.component'; // Importiere NgForOf aus dem CommonModule

@Component({
  selector: 'app-kapitel-08-interceptors',
  standalone: true,
  imports: [NgForOf], // Stelle sicher, dass NgForOf in den imports ist
  templateUrl: './kapitel-08-interceptors.component.html',
  styleUrls: ['./kapitel-08-interceptors.component.css'],
})
